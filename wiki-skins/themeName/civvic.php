 ...
 * Modified 2010, Serrano Pereira <figure002@gmail.com> as cavendish-mod
 * Modified 2011, Cătălin Frâncu <cata@francu.com> for Civvic.ro
 *
 * @todo document
 * @package MediaWiki
 * @subpackage Skins
 ...
 * @ingroup Skins
 */
class SkinCivvicBase extends SkinTemplate {
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = CIVVIC_SKIN_NAME;
		$this->stylename = CIVVIC_SKIN_NAME;
		$this->template  = CIVVIC_SKIN_NAME . 'Template';
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( CIVVIC_SKIN_NAME . '/main.css', 'screen' );
		if( $wgHandheldStyle ) {
 ...
 * @ingroup Skins
 */
class CivvicTemplateBase extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for Civvic.ro skin.
